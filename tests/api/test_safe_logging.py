...
from codefa.api import request_errors
from codefa.api.handlers import MessagesHandler, TokenCountHandler
from codefa.application import execution
...
def test_stream_ledger_default_debug_has_no_serialized_json_content():
    with patch("codefa.core.anthropic.streaming.emitter.logger.debug") as mock_debug:
...
def test_parse_cli_event_error_logs_metadata_by_default():
    ...
    with patch("codefa.messaging.event_parser.logger.info") as log_info:
        parse_cli_event(
...
def test_count_tokens_unexpected_error_default_logs_exclude_exception_text():
    ...
    from codefa.core.anthropic.models import TokenCountRequest
