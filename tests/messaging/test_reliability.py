...
from codefa.messaging.limiter import MessagingRateLimiter
from codefa.messaging.platforms.telegram import TelegramRuntime


@pytest.fixture
def telegram_platform():
    with patch("codefa.messaging.platforms.telegram.TELEGRAM_AVAILABLE", True):
