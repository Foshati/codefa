...
from codefa.messaging.platforms.factory import (
...
class TestCreateMessagingComponents:
    ...
    def test_telegram_with_token(self):
        ...
        with (
            patch(
                "codefa.messaging.platforms.factory.MessagingRateLimiter",
                return_value=limiter,
            ) as limiter_cls,
            patch("codefa.messaging.platforms.telegram.TELEGRAM_AVAILABLE", True),
            patch(
                "codefa.messaging.platforms.telegram.TelegramRuntime",
    ...
    def test_discord_with_token(self):
        ...
        with (
            ...
            patch("codefa.messaging.platforms.discord.DISCORD_AVAILABLE", True),
            patch(
                "codefa.messaging.platforms.discord.DiscordRuntime",
                return_value=mock_runtime,
            ) as runtime_cls,
        ):
            result = create_messaging_components(
