...
class TestManagedClaudeSession:
    ...
    def test_session_extract_session_id(self):
        ...
        from codefa.cli.managed.claude import (
    ...
    async def test_drain_stderr_bounded_retains_cap_but_drains_to_eof(self):
        ...
        from codefa.cli.managed.session import (
    ...
    async def test_stop_session(self):
        ...
        with patch("codefa.cli.managed.session.kill_pid_tree_best_effort") as kill_tree:
    ...
    async def test_start_task_json_error(self):
        """Test handling of non-JSON output from codefa.cli."""
        from codefa.cli.managed.session import ManagedClaudeSession
    ...
    async def test_stop_exception(self):
        ...
        with patch(
            "codefa.cli.managed.session.kill_pid_tree_best_effort",
