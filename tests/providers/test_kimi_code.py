...
from codefa.config.provider_catalog import KIMI_CODE_DEFAULT_BASE
...
def test_init_uses_subscription_endpoint_and_identifies_codefa(kimi_code_provider):
    ...
    assert kimi_code_provider._client.default_headers["User-Agent"] == ("codefa")
