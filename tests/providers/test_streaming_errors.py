...
from codefa.core.anthropic.streaming import (
...
from codefa.providers.openai_chat.provider import (
    _OpenAIChatStreamRunner,
)
from codefa.providers.openai_chat.tool_calls import (
    OpenAIToolCallAssembler,
    has_committed_sse_output,
    iter_heuristic_tool_use_sse,
)
from codefa.providers.stream_recovery import TruncatedProviderStreamError
...
class TestProcessToolCall:
    ...
    def test_heuristic_tool_use_sse_marks_committed_tool_output(self):
        ...
        from codefa.core.anthropic import AnthropicStreamLedger
