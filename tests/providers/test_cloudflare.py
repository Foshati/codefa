...
from codefa.config.provider_catalog import CLOUDFLARE_AI_REST_ROOT
...
from codefa.providers.cloudflare import (
    CloudflareProvider,
...
def test_init_composes_account_scoped_openai_chat_base_url(
    ...
    with (
        patch("codefa.providers.openai_chat.provider.AsyncOpenAI") as mock_openai,
