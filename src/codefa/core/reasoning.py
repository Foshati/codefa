...
class ReasoningEffort(StrEnum):
    """Named reasoning effort understood at the CODEFA application boundary."""
    ...
    def budget_tokens(self) -> int:
        """Return CODEFA's numeric token budget for this effort."""
...
class ReasoningPolicy:
    ...
    def numeric_budget_tokens(self) -> int | None:
        """Express this intent as an exact or CODEFA-mapped numeric budget."""
