...
CODEFA_CONFIG_DIRNAME = ".codefa"
CODEFA_ENV_FILENAME = ".env"
LEGACY_REPO_DIRNAME = "codefa"
LEGACY_XDG_CONFIG_DIRNAME = ".config"
MESSAGING_STATE_DIRNAME = "agent_workspace"
CODEFA_LOGS_DIRNAME = "logs"
...
def config_dir_path() -> Path:
    ...
    return Path.home() / CODEFA_CONFIG_DIRNAME


def managed_env_path() -> Path:
    """Return the default user-managed env file path."""

    return config_dir_path() / CODEFA_ENV_FILENAME


def legacy_env_paths() -> tuple[Path, ...]:
    """Return legacy user env paths that can be migrated to ~/.codefa/.env."""

    home = Path.home()
    return (
        home / LEGACY_REPO_DIRNAME / CODEFA_ENV_FILENAME,
        home / LEGACY_XDG_CONFIG_DIRNAME / LEGACY_REPO_DIRNAME / CODEFA_ENV_FILENAME,
    )
...
def server_log_path() -> Path:
    ...
    return config_dir_path() / CODEFA_LOGS_DIRNAME / SERVER_LOG_FILENAME
