...
from codefa.application.execution import ProviderExecutor
...
from codefa.core.anthropic import MessagesRequest
    ...
    async def create(
        ...
        if request_data.stream is False:
            raise InvalidRequestError(
                "CODEFA /v1/responses supports streaming only; omit stream or set stream=true."
            )
