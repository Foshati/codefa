"""Direct HTTP and child-environment policy for CODEFA-local traffic."""
...
def open_local_request(request: Request, *, timeout: float) -> Any:
    """Open an CODEFA-local request without consulting machine proxy settings."""
...
def with_local_proxy_bypass(
    ...
    *,
    ...
    """Copy an environment and keep its CODEFA-local destination off proxies."""
