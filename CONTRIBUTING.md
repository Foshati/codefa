...
```bash
git clone https://github.com/Foshati/codefa.git
cd codefa
uv python install 3.14.0
uv run codefa-server
```
...
- Keep shared Anthropic protocol behavior under `src/codefa/core/anthropic/` rather than importing utilities from another provider.
