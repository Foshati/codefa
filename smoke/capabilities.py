...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "codefa.api.handlers.messages.MessagesHandler",
    ...
    CapabilityContract(
        ...
        "codefa.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "codefa.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "codefa.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "codefa.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "codefa.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "codefa.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "codefa.core.anthropic.thinking",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "codefa.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "codefa.api.optimization_handlers",
    ...
    CapabilityContract(
        ...
        "codefa.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "codefa.config.settings.Settings",
        "process env, user env file, repo env file, CODEFA_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "codefa.config.settings.Settings",
        "retired ENABLE_MODEL_THINKING or tier override in an CODEFA-owned dotenv",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "codefa.providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "codefa.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "codefa.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "codefa.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "codefa.messaging.workflow.MessagingWorkflow",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "codefa.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "codefa.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "codefa.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        (
            "test_codefa_init_scaffolds_user_config",
            "test_codefa_entrypoint_starts_server",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "codefa.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "codex_cli_drop_in",
        "drop_in_codex_replacement",
        "codefa.cli.launchers.codex",
        "Codex CLI binary and codefa provider env",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "codefa.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and CODEFA child-process environment",
        "Anthropic Messages provider with an CODEFA-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "codefa.providers.runtime and codefa.messaging.platforms.factory",
