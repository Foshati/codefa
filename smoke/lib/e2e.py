...
from codefa.config.provider_catalog import SUPPORTED_PROVIDER_IDS
...
from codefa.messaging.voice import VoiceCancellationResult
...
class ConversationDriver:
    ...
    def ask(
        ...
        text: str,
        *,
        model: str = "codefa-smoke-default",
        max_tokens: int = 256,
...
class ProviderMatrixDriver:
    ...
    def provider_smoke_models(self) -> list[ProviderModel]:
        ...
        if not models and os.getenv("CODEFA_ALLOW_NO_PROVIDER_SMOKE") != "1":
            fail_missing_env(
                "no configured provider smoke models; set CODEFA_ALLOW_NO_PROVIDER_SMOKE=1 "
    ...
    def adaptive_thinking_payload() -> dict[str, Any]:
        return {
            ...
            "messages": [
                ...
                {"role": "user", "content": "Reply with exactly CODEFA_SMOKE_CLIENT"},
            ],
                    ...
                    "content": [
                        {
                            ...
                            "name": "echo_smoke",
                            "input": {"value": "CODEFA_SMOKE_CLIENT"},
                        }
                    ],
                },
                {
...
class FakePlatform:
    ...
    def continue_message_sequence_after(self, previous: FakePlatform) -> None:
        """Model platform-owned message IDs surviving an CODEFA restart."""
