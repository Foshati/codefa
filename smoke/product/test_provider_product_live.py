...
def test_provider_error_e2e(smoke_config: SmokeConfig) -> None:
    ...
    broken_model = f"{provider_model.provider}/codefa-smoke-missing-model"
    with (
        SmokeServerDriver(
            smoke_config,
            ...
            {"role": "user", "content": "Use the tool."},
            {
                ...
                "content": [
                    ...
                    {"type": "text", "text": "I will call the tool."},
                    {
                        ...
                        "name": "echo_smoke",
                        "input": {"value": "CODEFA_INTERLEAVED"},
                    },
                ],
            },
            {
...
def _scenario_tool_result_continuation(
    ...
    first_payload = {
        ...
        "max_tokens": 256,
        "messages": [
            {"role": "user", "content": "Use echo_smoke once with value CODEFA_TOOL."}
        ],
        "tools": [echo_tool_schema()],
